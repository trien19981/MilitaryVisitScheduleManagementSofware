# Hướng dẫn cấu hình SSL/HTTPS cho domain api.thamhoi.io.vn

## Yêu cầu trước khi bắt đầu

1. **Domain đã được cấu hình DNS**: Domain `api.thamhoi.io.vn` phải trỏ về IP server của bạn
...
Sau đó bạn có thể truy cập API qua HTTP: `http://api.thamhoi.io.vn`
...
# Test HTTPS
curl https://api.thamhoi.io.vn/api/health
```
...
- Kiểm tra DNS: `dig api.thamhoi.io.vn`
